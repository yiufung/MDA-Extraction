...
result.write("    # all mda. only consider mda in item 6 or item 7. \n")
...
result.write("    # item 7 is finan but item 6 is not MDA. \n")
result.write("    # improvements may be found here \n")
result.write("Fail files: "+str(len(faillist))+"\n")
result.write("    # fail cases.. \n")
result.write("    # improvements may be found here \n")
result.write("\n\n")
